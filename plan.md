...
- [~] **M9-3** The `image` widget (D132), the Pictures tab, and **the forming preview inside the trace entry** (D135) are done; **the graph is not** — Phase 3's two layout limits are still undecided
