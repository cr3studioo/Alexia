...
- [~] **M9-2** The catalogue, its search and **installing one** are done (`catalog.js`, `find_workflow`, `install_workflow` — D137, no consent ladder needed); the bento grid, the lifecycle and the drop zone still need C2 and C4
