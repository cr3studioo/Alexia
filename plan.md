...
- [ ] **M8-6** Models: listed when usable, ranked best to worst, and three fallback modes *(inserted 2026-09-15, D154–D155, D158–D159 — see [`model_plan.md`](./model_plan.md))*
- [ ] **M8-7** Personality v2: three sizes and ten improvements *(inserted 2026-09-15, D156–D157 — see [`plan-personality.md`](./plan-personality.md))*
