...
- **A fixed never-touch list Alexia ships** — credential stores, system directories, its own
  config. Not editable, not overridden by any mode except explicit Full trust.
